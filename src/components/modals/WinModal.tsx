...
export const WinModal = () => {
  ...
  const modal = () => (modalOpen()?.type === "WinModal" ? modalOpen() : null);
      ...
      >
        <div class="relative w-full max-w-lg max-h-full">
          <div class="text-center relative bg-white rounded-lg shadow ">
            ...
            <h3 class="text-4xl font-medium text-gray-900 mb-8">You Won!</h3>

            <div class="text-9xl mb-10">🎉</div>

            <div class="pb-10">
              <p class="text-gray-700 text-xl">Hell yeah! You rule!</p>
            </div>
